...
<head>
    ...
    <!--
    <title>Rumi and Tagore: Poets of Divine Love</title>
    -->
    <style>
        body {
        ...
        blockquote {
            ...
            font-style: italic;
	    font-family: 'Cursive', sans-serif; /* This line sets the font to cursive */
        }
        footer {
...
<p> Ravindranath Tagore's own family was a confluence of three cultures: "Hinduism",
